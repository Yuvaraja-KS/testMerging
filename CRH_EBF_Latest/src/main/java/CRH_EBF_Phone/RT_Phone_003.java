...
public class RT_Phone_003 extends CommonFunctions {
	...
	public RT_Phone_003(String s) 
	{
				...
				this.path = s;
			//	this.path1 = internet;
				logger.info("add Phone 03 is intialized");
	}
...
//Validation of continue button (disabled)		
				  	        ...
				  	        Tv_Internet_phone(br,Tv_plan,Tv_service,Internet_plan,Internet_service,Phone_plan,Phone_service,driver);
						    Thread.sleep(4000);
						   click_element(".//*[@name='upgrade_tv']", driver);
						    Thread.sleep(2000);
						    click_element(".//*[@name='customize_phone']", driver);						   					    
						    Thread.sleep(2000);
						    				  
						    {
				    	 	if(driver.findElement(By.xpath("//*[@class='button-nav ']/a")).isEnabled())
							{logger.info("Fail");
							statusTracker(br,driver,"Pass", "Continue button on service page", "Disabled", "should be disabled");												 
							}
				    	 	else
							{logger.info("Pass");
							statusTracker(br,driver,"fail", "Continue button on service page","Enabled", "should be disabled" );
							}
				    	 	Thread.sleep(3000);
