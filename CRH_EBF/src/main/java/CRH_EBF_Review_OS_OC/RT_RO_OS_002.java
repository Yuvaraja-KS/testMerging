...
//File Name: RT_RO_OS_002
//Author: Nithin 
//Description of test case: Review Order -ECK Pickup - Validate 3 closest pickup locations
//Date of creation(D/M/Y): 3/14/2014
//Name and date(D/M/Y) of modification: RAHUL JADOW (9/6/2014)
 
//Name and date(D/M/Y) of modification: RAHUL JADOW (30/6/2014)
...
public class RT_RO_OS_002 extends CommonFunctions {
	...
	public RT_RO_OS_002(String s) {
		this.path = s;
		logger.info("RT_RO_OS_002 is intialized");
	}
		...
		/*
			...
			*/
			...
			try {
				...
				Thread.sleep(15000);
				driver.findElement(
						By.xpath(".//*[@class='plans']/div[3]/header/ul/li[5]/div/a/span")).click();
				Thread.sleep(10000);
