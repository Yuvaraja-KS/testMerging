...
public class RO_OS_Validation extends CommonFunctions {
	...
	Sheet sheet2 = wb1.getSheet("Adult");
...
TableFormat1_spaceline = new WritableFont(WritableFont.TAHOMA, 11,
	...
	try {
		...
		if (firstpage) {
			...
			lbl = new Label(0, 0, "EBF REGRESSION - REVIEW_OS_OC REGRESSION - TEST RESULTS", tfb1_heading);
			sheet1.addCell(lbl);
			...
			logger.info("*******check1");
			 ...
			 File data11 = new File(path);
				...
				logger.info("*******check6");
				Sheet sheet11 = wb11.getSheet("Review_OS_OC");
				logger.info("*******check7");
				...
				ws1.setLocale(new Locale("er", "ER"));
				 ...
				 sheet2 = wb1.getSheet("Review_OS_OC");
				...
				if ((exec1.equals("Y")) || (exec1.equals("y"))) {
					...
					if(loc==Row_locator_full_scan_validation("RT_RO_OS_001",path,"Review_OS_OC"))  
		                 pass+=obj_run( new RT_RO_OS_001(path),0,sheet1,name1,loc,Overall_Path,env,br,br_specific);
				 if(loc==Row_locator_full_scan_validation("RT_RO_OS_002",path,"Review_OS_OC"))  
	                 pass+=obj_run( new RT_RO_OS_002(path),0,sheet1,name1,loc,Overall_Path,env,br,br_specific);
				 if(loc==Row_locator_full_scan_validation("RT_RO_OS_003",path,"Review_OS_OC"))  
	                 pass+=obj_run( new RT_RO_OS_003(path),0,sheet1,name1,loc,Overall_Path,env,br,br_specific);
				 if(loc==Row_locator_full_scan_validation("RT_RO_OS_004",path,"Review_OS_OC"))  
	                 pass+=obj_run( new RT_RO_OS_004(path),0,sheet1,name1,loc,Overall_Path,env,br,br_specific);
				 if(loc==Row_locator_full_scan_validation("RT_RO_OS_005",path,"Review_OS_OC"))  
	                 pass+=obj_run( new RT_RO_OS_005(path),0,sheet1,name1,loc,Overall_Path,env,br,br_specific);
				 if(loc==Row_locator_full_scan_validation("RT_RO_OS_006",path,"Review_OS_OC"))  
	                 pass+=obj_run( new RT_RO_OS_006(path),0,sheet1,name1,loc,Overall_Path,env,br,br_specific);
				 if(loc==Row_locator_full_scan_validation("RT_RO_OS_007",path,"Review_OS_OC"))  
	                 pass+=obj_run( new RT_RO_OS_007(path),0,sheet1,name1,loc,Overall_Path,env,br,br_specific);
				 if(loc==Row_locator_full_scan_validation("RT_RO_OS_008",path,"Review_OS_OC"))  
	                 pass+=obj_run( new RT_RO_OS_008(path),0,sheet1,name1,loc,Overall_Path,env,br,br_specific);
				 if(loc==Row_locator_full_scan_validation("RT_RO_OS_009",path,"Review_OS_OC"))  
	                 pass+=obj_run( new RT_RO_OS_009(path),0,sheet1,name1,loc,Overall_Path,env,br,br_specific);
				 if(loc==Row_locator_full_scan_validation("RT_RO_OS_0010",path,"Review_OS_OC"))  
	                 pass+=obj_run( new RT_RO_OS_010(path),0,sheet1,name1,loc,Overall_Path,env,br,br_specific);
				 if(loc==Row_locator_full_scan_validation("RT_RO_OS_0011",path,"Review_OS_OC"))  
	                 pass+=obj_run( new RT_RO_OS_011(path),0,sheet1,name1,loc,Overall_Path,env,br,br_specific);
				 if(loc==Row_locator_full_scan_validation("RT_RO_OS_0012",path,"Review_OS_OC"))  
	                 pass+=obj_run( new RT_RO_OS_012(path),0,sheet1,name1,loc,Overall_Path,env,br,br_specific);
				 if(loc==Row_locator_full_scan_validation("RT_RO_OS_0013",path,"Review_OS_OC"))  
	                 pass+=obj_run( new RT_RO_OS_013(path),0,sheet1,name1,loc,Overall_Path,env,br,br_specific);
	    ...
	    if(Test_called<brinst)
      {
	    ...
	    //Failure assertion changes -JS Start
	       ...
	       //Failure assertion changes -JS end
