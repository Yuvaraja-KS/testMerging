...
//File Name: RT_RO_OS_001
//Author: Nithin 
//Description of test case: Review Order-Install Options-validate driven by SIK eligibility established (SIK pickup, SIK mail, technician install)
...
public class RT_RO_OS_001 extends CommonFunctions {
	...
	public RT_RO_OS_001(String s) {
		this.path = s;

		logger.info("RT_RO_OS_001 is intialized");
	}
	...
	public void execute(String br,WebDriver driver, String url, int loc,String Overall_Path,String env) throws Exception {
		...
		try {
			...
			try {
				...
				click_element(".//*[@class='plans']/div[3]/header/ul/li[5]/div/a/span", driver);
				Thread.sleep(10000);
...
//Image_compare changes -JS Start
                  ...
                  //Image_compare changes -JS End
					...
					System.out
							.println("Review Page - Validating the Installation Options - Internet");
					Thread.sleep(5000);
					...
					if (driver.findElement(
						...
						click_element(".//*[@data-name='Mail to Home']", driver);
			    		 Thread.sleep(6000);
					} else
						statusTracker(br,driver,
								"Fail",
					...
					if (driver.findElement(
						...
						click_element(".//*[@data-name='Technician Visit']", driver);
			    		Thread.sleep(6000);
					...
					if (Isavailable(".//a[@data-lob='Internet']", driver))
