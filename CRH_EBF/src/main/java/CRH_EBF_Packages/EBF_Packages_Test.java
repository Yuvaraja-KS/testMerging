...
public class EBF_Packages_Test extends CommonFunctions{
	...
	public void Reader() throws IOException, BiffException, InterruptedException
	{
		...
		outputfile=spath+path_config.getProperty("resultSheetPackages");
		...
		sheet11 = wb11.getSheet("Packages");
...
int first_row=Row_locator_full_scan("CHILD TEST CASE",inputfile,"Packages");
		...
		File Pass_a = new File(spath+ "//" + "//Test_Results"+"//"+newFolderPCName+"//"+"CRH_EBF_Packages_Pass_Screenshots////");
		deleteFolder(Pass_a);
		File Fail_a = new File(spath + "//" + "//Test_Results"+"//"+newFolderPCName+"//"+"CRH_EBF_Packages_Fail_Screenshots////");
		deleteFolder(Fail_a);
		File Exception_a = new File(spath + "//" + "//Test_Results"+"//"+newFolderPCName+"//"+"CRH_EBF_Packages_Exception_Screenshots////");
		deleteFolder(Exception_a);
		// to create a folder for saving the images
 		File NewImages = new File(spath + "//"+"//Test_Results"+"//"+newFolderPCName+"//"+ "CRH_EBF_TV_Screenshots_ImageComparison");
 		deleteFolder(NewImages);
	...
	public  void RT_Package_001 ( String br) {
		loc=7;
		...
		logger.info("RT_Package_001 is called");
		logger.info("Test 1 is called");
		Package_Validation a = new Package_Validation();
	...
	@Test(dataProvider="getData",priority=2)
		public  void RT_Package_002 ( String br) throws Exception
		{
			loc=8;
			...
			logger.info("RT_Package_002 is called");
			logger.info("Test 1 is called");
			Package_Validation a = new Package_Validation();
			...
			try {
					...
					{			
						Test_called++;
						logger.info("Test_called in main RT_Package_002 is"+Test_called );
	...
	public  void RT_Package_003 ( String br) throws Exception
	{
		loc=9;
		String exec1 = sheet11.getCell(3, loc).getContents();
		logger.info(sheet11.getCell(0, loc).getContents()+" "+exec1);
		...
		logger.info("RT_Package_003 is called");
		logger.info("Test 1 is called");
		Package_Validation a = new Package_Validation();
		...
		try {
				...
				{			
					Test_called++;
					logger.info("Test_called in main RT_Package_003 is"+Test_called );
	...
	public  void RT_Package_004 ( String br) throws Exception
	{
		loc=10;
		String exec1 = sheet11.getCell(3, loc).getContents();
		logger.info(sheet11.getCell(0, loc).getContents()+" "+exec1);
		...
		logger.info("RT_Package_004 is called");
		logger.info("Test 1 is called");
		Package_Validation a = new Package_Validation();
		...
		try {
				...
				{			
					Test_called++;
					logger.info("Test_called in main RT_Package_004 is"+Test_called );
	...
	public  void RT_Package_005 ( String br) throws Exception
	{
		loc=11;
		String exec1 = sheet11.getCell(3, loc).getContents();
		logger.info(sheet11.getCell(0, loc).getContents()+" "+exec1);
		...
		logger.info("RT_Package_005 is called");
		logger.info("Test 1 is called");
		Package_Validation a = new Package_Validation();
		...
		try {
				...
				{			
					Test_called++;
					logger.info("Test_called in main RT_Package_005 is"+Test_called );
				...
				logger.info("local value in test1 is "+loc);
	...
	public  void RT_Package_006 ( String br) throws Exception
	{
		loc=12;
		String exec1 = sheet11.getCell(3, loc).getContents();
		logger.info(sheet11.getCell(0, loc).getContents()+" "+exec1);
		...
		logger.info("RT_Package_006 is called");
		logger.info("Test 1 is called");
		Package_Validation a = new Package_Validation();
		...
		try {
				...
				{			
					Test_called++;
					logger.info("Test_called in main RT_Package_006 is"+Test_called );
	...
	public  void RT_Package_007 ( String br) throws Exception
	{
		loc=13;
		String exec1 = sheet11.getCell(3, loc).getContents();
		logger.info(sheet11.getCell(0, loc).getContents()+" "+exec1);
		...
		logger.info("RT_Package_007 is called");
		logger.info("Test 1 is called");
		Package_Validation a = new Package_Validation();
		...
		try {
				...
				{			
					Test_called++;
					logger.info("Test_called in main RT_Package_007 is"+Test_called );
	...
	public  void RT_Package_008 ( String br) throws Exception
	{
		loc=14;
		String exec1 = sheet11.getCell(3, loc).getContents();
		logger.info(sheet11.getCell(0, loc).getContents()+" "+exec1);
		...
		logger.info("RT_Package_008 is called");
		logger.info("Test 1 is called");
		Package_Validation a = new Package_Validation();
		...
		try {
				...
				{			
					Test_called++;
					logger.info("Test_called in main RT_Package_008 is"+Test_called );
	...
	public  void RT_Package_011 ( String br) throws Exception
	{
		loc=17;
		String exec1 = sheet11.getCell(3, loc).getContents();
		logger.info(sheet11.getCell(0, loc).getContents()+" "+exec1);
		...
		logger.info("RT_Package_011 is called");
		logger.info("Test 1 is called");
		Package_Validation a = new Package_Validation();
		...
		try {
				...
				{			
					Test_called++;
					logger.info("Test_called in main RT_Package_011 is"+Test_called );
	...
	public  void RT_Package_012 ( String br) throws Exception
	{
		loc=18;
		String exec1 = sheet11.getCell(3, loc).getContents();
		logger.info(sheet11.getCell(0, loc).getContents()+" "+exec1);
		...
		logger.info("RT_Package_012 is called");
		logger.info("Test 1 is called");
		Package_Validation a = new Package_Validation();
		...
		try {
				...
				{			
					Test_called++;
					logger.info("Test_called in main RT_Package_012 is"+Test_called );
