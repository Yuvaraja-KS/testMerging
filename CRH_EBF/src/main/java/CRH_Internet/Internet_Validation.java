...
public class Internet_Validation extends CommonFunctions {
...
Sheet sheet2 = wb1.getSheet("Internet");
...
try {
	...
	if (firstpage) {
		...
		lbl = new Label(0, 0, "EBF Regression - INTERNET - TEST RESULTS", tfb1_heading);
		sheet1.addCell(lbl);
		...
		logger.info("*******check1");
		 ...
		 File data11 = new File(path);
			...
			logger.info("*******check6");
			Sheet sheet11 = wb11.getSheet("Internet");
			logger.info("*******check7");
			...
			if ((exec1.equals("Y")) || (exec1.equals("y"))) {
				...
				System.out.println("Initial Time "+st);
				  ...
				  if (loc == Row_locator_full_scan_validation("RT_Internet_001",path,"Internet"))
		        	  pass += obj_run(new RT_Internet_001(path), 0,sheet1, name1,loc,br,br_specific);
		          
		          else if (loc == Row_locator_full_scan_validation("RT_Internet_002",path,"Internet"))
		        	  pass += obj_run(new RT_Internet_002(path), 0,sheet1, name1,loc,br,br_specific);
		          
		          else if (loc == Row_locator_full_scan_validation("RT_Internet_003",path,"Internet"))
		        	  pass += obj_run(new RT_Internet_003(path), 0,sheet1, name1,loc,br,br_specific);
				  
		          else if (loc == Row_locator_full_scan_validation("RT_Internet_004",path,"Internet"))
		        	  pass += obj_run(new RT_Internet_004(path), 0,sheet1, name1,loc,br,br_specific);
		          
		          else if (loc == Row_locator_full_scan_validation("RT_Internet_005",path,"Internet"))
			       pass += obj_run(new RT_Internet_005(path), 0,sheet1, name1,loc,br,br_specific);
		          
		          else if (loc == Row_locator_full_scan_validation("RT_Internet_006",path,"Internet"))
		        	  pass += obj_run(new RT_Internet_006(path), 0,sheet1, name1,loc,br,br_specific);
		          
		          else if (loc == Row_locator_full_scan_validation("RT_Internet_007",path,"Internet"))
	      	        pass += obj_run(new RT_Internet_007(path), 0,sheet1, name1,loc,br,br_specific);
				  
				  
		          else if (loc == Row_locator_full_scan_validation("RT_Internet_008",path,"Internet"))
		      	        pass += obj_run(new RT_Internet_008(path), 0,sheet1, name1,loc,br,br_specific);
				  
		          
		          else if (loc == Row_locator_full_scan_validation("RT_Internet_009",path,"Internet"))
	    	        pass += obj_run(new RT_Internet_009(path), 0,sheet1, name1,loc,br,br_specific);
		          
		          else if (loc == Row_locator_full_scan_validation("RT_Internet_010",path,"Internet"))
		        	  pass += obj_run(new RT_Internet_010(path), 0,sheet1, name1,loc,br,br_specific);
		          
		          else if (loc == Row_locator_full_scan_validation("RT_Internet_011",path,"Internet"))
		        	  pass += obj_run(new RT_Internet_011(path), 0,sheet1, name1,loc,br,br_specific);
		          
		          else if (loc == Row_locator_full_scan_validation("RT_Internet_012",path,"Internet"))
		        	  pass += obj_run(new RT_Internet_012(path), 0,sheet1, name1,loc,br,br_specific);
