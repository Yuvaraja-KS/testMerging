...
//import screen_recording.SpecializedScreenRecorder;
//import screen_recording.VideoRecord;
...
public abstract class CommonFunctions {
	...
	public String getStatus() {
		String b = "Fail";
		if (CommonFunctions.result.equals("Pass"))
			b = "Pass";
		return b;
	}
    ...
    //RJ Billling
	 ...
	 public void Internet_TWClogo(String br, WebDriver driver) throws Exception 
	 {
			// validationofTWClogo
	...
	*/
	...
	public void statusTracker( String br, WebDriver driver, String r, String rscenario,
     ...
     String imagename = spath+ "//" + "//Test_Results"+"//"+newFolderPCName+ "////"
                  + "CRH_EBF_Internet_Fail_Screenshots//"+br+"////" + Page_Phone
                  + "_Int_Fail";
     ...
     */
     ...
     if (r.equalsIgnoreCase("pass")) {
            ...
            if (pass_screenshot_required == true) {
                  String imagename_1 =spath+ "//" + "//Test_Results"+"//"+newFolderPCName + "////" + "CRH_EBF_Internet_Pass_Screenshots//"+br+"////"
	...
	public String exceptionHandler(String br, Exception ex, WebDriver driver) {
		 vCheck = 1;
		logger.info("excption in excep handler is "+ex);
		String s = "";
		String name = "image";
		try {
			throw ex;
			...
			String Folder_name = "Internet_";
			//computer_name folder changes -ankita
	
			String imagename = spath+ "//" + "//Test_Results"+"//"+newFolderPCName+ "////"
	                 + "CRH_EBF_Internet_Exception_Screenshots///"+br+"////" + Page_Phone
	                 + "_Int_Exception";
			SimpleDateFormat ft = new SimpleDateFormat("'_'MMMM dd'_'hh.mma");
			Date dNow = new Date();
		...
		try {
			if (first == 0) {
				...
				logger.info(url);
					...
					//vid recording changes - abhimanyu
					...
					// ScreenRecorder screenRecorder = new ScreenRecorder(gc,new Format(MediaTypeKey, MediaType.FILE, MimeTypeKey, MIME_AVI),new Format(MediaTypeKey, MediaType.VIDEO, EncodingKey, ENCODING_AVI_TECHSMITH_SCREEN_CAPTURE,CompressorNameKey, ENCODING_AVI_TECHSMITH_SCREEN_CAPTURE,DepthKey, 24, FrameRateKey, Rational.valueOf(15),QualityKey, 1.0f,KeyFrameIntervalKey, 15 * 60),new Format(MediaTypeKey,MediaType.VIDEO, EncodingKey, "black",FrameRateKey, Rational.valueOf(30)),null);
					 ...
					 System.out.println(loc+"Hiiiii" +video);
					 if(video.equalsIgnoreCase("Y"))
					 {
						// System.out.println("Check111");
						 startRecording();   
						// System.out.println("Check444");
				         //stopRecording();
...
*/
	...
	public void firstrun(String br, WebDriver driver, String username, String pwd
		...
		logger.info("First run is called"+ br+" "+name1);
		...
		logger.info("-------First run is called-----usrname-"+ br+" " +name1);
		driver.findElement(By.name("password")).sendKeys(pwd);	
		logger.info("-------First run is called---pwd---"+ br+" " +name1);
		...
		logger.info(" Logged in"+br +" "+name1);
...

	{
		...
		Double Decimal_Amount = Double.parseDouble(start_amount
				.replace("$", "")) / 100;
		logger.info("AG Check" +start_amount);
...
//**************************************************************************************************************
		 //Commentted Nimy/Aashish
		
		/*driver.findElement(By.xpath("html/body/section/div[3]/div[2]/div[2]/div/div/div[2]/div[1]/form/ul/li[1]/div[2]/div[2]/a/span[1]")).click();
...
//*****************************************************************************************************
	...
	public void Tv_Internet_lob_verify(String br,WebDriver driver)
...

		{
			...
			Thread.sleep(10000);
			//driver.findElement(By.cssSelector("span.no-arrow")).click();
			click_element("html/body/section/div[3]/div[2]/div[2]/div/div/div[2]/div[1]/form/ul/li[1]/div[2]/div[2]/a/span[1]",driver);
			if (return_text("//*[@class='modal-title']", driver)
	...
	public void Internet_Phone_lob_verify(String br,WebDriver driver)
...

		{
			...
			Thread.sleep(2000);
			click_element("//*[@id='js-main-form']/ul/li[1]/div[2]/div[2]/a/span[1]",driver);
			// driver.findElement(By.cssSelector("span.no-arrow")).click();
			Thread.sleep(10000);
	 ...
	 */
	 ...
	 public void select_Firstchoice_Date(String br,int DDValue, WebDriver drive)
			...
			WebElement element = drive.findElement(By.xpath(".//input[@id='first-choice-date1']"));
	 ...
	 */
	 ...
	 public void select_Secondchoice_Date(String br,int DDValue, WebDriver drive)
			...
			logger.info("select_Secondchoice_Date....1 : " + DDValue);
			click_element(".//input[@id='second-choice-date1']",drive);
	...
	public void OrderSummary_ChkBrowserBackButton(String br, WebDriver driver) throws InterruptedException {
	...
	public void transfer_number(String br, WebDriver driver) throws InterruptedException {
		...
		click_element("//*[@class='modal modalGeneric js-modal-initialized']",drive);
		logger.info("two");
		...
		click_element("//*[@class='modal-button-close']",drive);
		Thread.sleep(5000);
	...
	public void I_will_use_my_modem(WebDriver driver)
		...
		click_element("//*[@id='js-main-form']/div[2]/div[3]/header/ul/li[1]/a",driver);
		Thread.sleep(2000);
		click_element("//*[@id='js-main-form']/div[2]/div[3]/header/ul/li[1]/a",driver);
	...
	public void InternetModem(WebDriver driver) throws InterruptedException {
		...
		click_element("//*[@id='1-29OW']",driver);
	...
	public void Internet_Equipment_Click(String br, WebDriver drive) {
		if (Isavailable(".//*[@name='customize_inet']", drive)) {
			click_element(".//*[@name='customize_inet']",drive);
			statusTracker(br,drive, "Pass",
	...
	public void Customization_TV_OpenChannel() {
		click_element(".//*[@class='tv-customize-accordion']/div[2]/header/ul/li[1]/a",drive);
	}
...
itemcost[jk] = driver.findElement(By.xpath("//*[@id='content']/div[3]/div[2]/div/div[1]/div/div/div/div/section/div[1]/div["+ (jk + 1) + "]/header/ul/li[3]")).getText();
	...
	public void Customization_TV_addPremiumChannels(String br, WebDriver drive)
		...
		if (Isavailable(".//*[@id='1-3CEN9-1-2AW3-1']/td[1]/input", drive)) {
			...
			click_element(".//*[@id='1-3CEN9-1-2AW3-1']/td[1]/input",drive);
			Thread.sleep(5000);
	...
	public void Customization_TV_addSportsChannels_InstallmentPricing(String br, WebDriver drive) throws InterruptedException {
		...
		if (Isavailable("//input[@data-name='NBA League Pass']", drive)) {
			statusTracker(br,drive, 
					...
					"NBA League Pass Channel must be available",
					"NBA League Pass Channel is displayed");
			click_element("//input[@data-name='NBA League Pass']",drive);
			Thread.sleep(5000);
...
public void Phone_Equipment_Click(String br, WebDriver drive) {
              if (Isavailable(".//*[@name='customize_phone']", drive)) {
            	  click_element(".//*[@name='customize_phone']",drive);
                     statusTracker(br,drive, "Pass",
...
//      logger.info(listOfFiles[0].getName());
  	...
  	//String name1 = name.replace(".jpg",".png");
		...
		File output_image = new File(Overall_Path +"//Test_Results//"+Folder_Name+ "//BRH_EBF_Internet//"+br+"//"+name+".png");
		FileUtils.copyFile(screenshot, output_image);		
		logger.info("copied file into New Images folder"+output_image);
     	File input_image=new File (Overall_Path+"//For_Image_Comparison//"+environment+"//BRH_EBF_Internet//"+br+"//"+name+".png");
...
public void Tv_Phone_LOS(String br, String Tv_plan,
		String Tv_service,String Phone_plan, String Phone_service, WebDriver driver) {
	

	String str1= driver.findElement(By.xpath(".//*[@class='services']/li[1]/div[2]/h4/div")).getText();
	String str2= driver.findElement(By.xpath(".//*[@class='services']/li[1]/div[2]/div[1]/div/p")).getText();
	
	logger.info("str1 " + str1);
	logger.info("str2 " + str2);


	if (return_text(".//*[@class='services']/li[1]/div[2]/h4/div", driver)
			.equals(str1)) 
	{
		if (return_text(".//*[@class='services']/li[1]/div[2]/div[1]/div/p",
				driver).equals(str2))

		{
			statusTracker(br,driver, "Pass",
					"check for TV LOS plan in current service",
					"Plan matches ", "Plan Should Match");
		} else {
			statusTracker(br,driver, "Fail",
					"check for TV LOS plan in current service",
	...
	String str3= driver.findElement(By.xpath(".//*[@class='services']/li[2]/div[2]/h4/div")).getText();
	String str4= driver.findElement(By.xpath(".//*[@class='services']/li[2]/div[2]/div[1]/div/p")).getText();
	
	logger.info("str3 " + str3);
	logger.info("str4 " + str4);
	
	if (return_text(".//*[@class='services']/li[2]/div[2]/h4/div", driver)
			.equals(str3)) {
		if (return_text(".//*[@class='services']/li[2]/div[2]/div[1]/div/p",
				driver).equals(str4))

		{
			logger.info("*****Check2****");
			statusTracker(br,driver, "Pass",
					"check for Phone LOS plan in current service",
					"Plan matches ", "Plan Should Match");
		} else {
			statusTracker(br,driver, "Fail",
					"check for Phone LOS plan in current service",
...
//RJ
	...
	public void field_statustracker1(String br, String xp, String tc, String Actual,
			WebDriver driver) {
		
		String value = driver.findElement(By.xpath(xp)).getAttribute("value");
		String value1 = driver.findElement(By.xpath(xp)).getText();
		
		if (value.equals("")) {
			statusTracker(br,driver, "Pass", tc, Actual, "Data is Entered");

		} else {
			statusTracker(br,driver, "Fail", tc, Actual, "Data is NOT Entered");

		}
	}

	public void field_statustracker2(String br, String xp, String tc, String Actual,
			WebDriver driver) {

		String value = driver.findElement(By.xpath(xp)).getAttribute("value");

		if (value.equals("")) {
			statusTracker(br,driver, "Fail", tc, Actual, "Invalid Data is Entered");

		} else {
			statusTracker(br,driver, "Pass", tc, Actual, "Invalid Data is Entered");

		}
	}
	public void firstrun(String br,String st_address, WebDriver driver,  String zip_code,
			String ctotal, String Uname, String serAddress)
			throws InterruptedException {

		click_element(".//*[@class='twc-first active']",driver);
		
		statusTracker(br,driver,"Pass", "User selects the New Customer tab",
				"User selects New Customer tab",
				"User is displayed with the New customer gateway page.");

		// Validate the fields displayed in the gateway page
		if (driver.findElement(By.xpath(".//*[@name='st_address']"))
				.isDisplayed())
			if (driver.findElement(By.xpath(".//*[@name='zip_code']"))
					.isDisplayed())
				if (driver.findElement(
						By.xpath(".//*[@name='unit_type']"))
						.isDisplayed())
					if (driver.findElement(
							By.xpath(".//*[@name='unit_number']"))
							.isDisplayed()) {
						statusTracker(br,driver,
								"Pass",
								"Fields displayed in the gateway page -> Street address, Zip code, unit type, unit number",
								"Field displayed in the gateway page is -> Street address, Zip code, unit type, unit number",
								"Field displayed in the gateway page should be-> Street address, Zip code, unit type, unit number");
					} else {
						statusTracker(br,driver,
								"Fail",
								"Fields displayed in the gateway page is not -> Street address, Zip code, unit type, unit number",
								"Field displayed in the gateway page is not -> Street address, Zip code, unit type, unit number",
								"Field displayed in the gateway page should be-> Street address, Zip code, unit type, unit number");
					}

		Thread.sleep(5000);

		driver.findElement(By.name("st_address")).sendKeys(st_address);
		statusTracker(br,driver,"Pass", "User enters TWC Street address ",
				"Street address displays",
				"should be able to enter the Street address");

		driver.findElement(By.name("zip_code")).sendKeys(zip_code);
		statusTracker(br,driver,"Pass", "User enters TWC zip code ",
				"zip code is entered and masked",
				"should be able to enter the zip code");
		int g = 0;
		try {
			do {
				click_element(".//*[@value='Submit']",driver);
				g++;
				logger.info("Log-in itteration is" + " " + g);
				Thread.sleep(2000);
		...
		statusTracker(br,driver,"Pass", "User selects Submit button",
				"Submit: Your Services page appears", "should be able to Login");

	}
	public String exceptionHandler(Exception ex, WebDriver driver) {
		System.out.println(" exception in ex handler is"+ex.getMessage());
		vCheck=1;
		String s = "";
		String name = "image";
		String br = "";
		try {
			...
			imagename = imagename.replaceAll(
					input_sheet,
					"//Test_Results"+"////CRH_EBF_Internet_Exception_Screenshots////" + Page_Phone
							+ "_Ext_Exception");
			SimpleDateFormat ft = new SimpleDateFormat("'_'MMMM dd'_'hh.mma");
			Date dNow = new Date();
			imagename = imagename + screenshot + ft.format(dNow) + ".png";
	...
	// validationofTWClogo
		...
		public void Billing_TWClogo(String br, WebDriver driver) throws Exception {

			logger.info("*******Before Click*********");
			logger.info(driver.getWindowHandle());
			String parentWin = driver.getWindowHandle();
			click_element(".//div[@class='img desktop']",driver);
			...
			if (subWinTitle.equals(subActitle)) {
				statusTracker(br,driver,"Pass", "TWC Logo is clickable and opens in new tab",
						"Clickable and opens in new tab",
						"Should be Clickable and should open in new tab");
			} else {
				statusTracker(br,driver,"Fail", "TWC Logo is clickable and opens in new tab",
						"Its NOT clickable",
						"Should be Clickable and should open in new tab");
			}
		...
		public void Billing_Payment_TWClogo(String br,WebDriver driver) throws Exception {
			 logger.info("*******Before Click*********");
			 logger.info(driver.getWindowHandle());
		...
		//	arrcount = 0;
			...
			if (UserName.equals(Uname)) {
				...
				logger.info("name match fails");
				statusTracker(br,driver,"Fail", "The first and last name doesnt match",
						"Doesnt Match", "Should match");
			}
		}

		public void explicit_Wait(int Timein_Seconds) {
			try {
				Thread.sleep(1000 * Timein_Seconds);
			} catch (InterruptedException e) {
				logger.info("Explicit Wait...." + e.getMessage());
				e.printStackTrace();
			}
	}
...
{    
   ...
   // String VideoRecord = this.getClass().getName();
   // System.out.println(VideoRecord);
    
   this.screenRecorder.start();
   System.out.println("Check333");
