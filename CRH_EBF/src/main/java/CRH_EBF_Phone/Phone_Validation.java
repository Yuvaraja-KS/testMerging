...
public class Phone_Validation  extends CommonFunctions
{
...
Sheet sheet2 = wb1.getSheet("Phone");
	...
	if (firstpage) {
		...
		logger.info("*******check1");
		 ...
		 File data11 = new File(path);
			...
			logger.info("*******check6");
			Sheet sheet11 = wb11.getSheet("Phone");
			logger.info("*******check7");
			...
			if ((exec1.equals("Y")) || (exec1.equals("y"))) {
				...
				if (loc == 7)
		        	  ...
		        	  pass += obj_run(new RT_Phone_002(path), 0,sheet1, name1,loc,br,br_specific);
		          else if (loc == 9)
		        	  pass += obj_run(new RT_Phone_003(path), 0,sheet1, name1,loc,br,br_specific);
		          else if (loc == 10)
		        	  pass += obj_run(new RT_Phone_004(path), 0,sheet1, name1,loc,br,br_specific);
		          else if (loc == 11)
		        	  pass += obj_run(new RT_Phone_005(path), 0,sheet1, name1,loc,br,br_specific);
		          else if (loc == 12)
		        	  pass += obj_run(new RT_Phone_006(path), 0,sheet1, name1,loc,br,br_specific);
		          else if (loc == 13)
		        	  pass += obj_run(new RT_Phone_007(path), 0,sheet1, name1,loc,br,br_specific);
		          else if (loc == 14)
		        	  pass += obj_run(new RT_Phone_008(path), 0,sheet1, name1,loc,br,br_specific);
		          else if (loc == 15)
		        	  pass += obj_run(new RT_Phone_009(path), 0,sheet1, name1,loc,br,br_specific);
		          else if (loc == 16)
		        	  pass += obj_run(new RT_Phone_010(path), 0,sheet1, name1,loc,br,br_specific);
		          else if (loc == 17)
		        	  pass += obj_run(new RT_Phone_011(path), 0,sheet1, name1,loc,br,br_specific);
		          else if (loc == 18)
		        	  pass += obj_run(new RT_Phone_012(path), 0,sheet1, name1,loc,br,br_specific);
		          /*else if (loc == 24)
		        	  pass += obj_run(new RT_Phone_013(path), 0,sheet1, name1,loc);*/
		          else if (loc == 20)
		        	  pass += obj_run(new RT_Phone_014(path), 0,sheet1, name1,loc,br,br_specific);
		          else if (loc == 21)
		        	  pass += obj_run(new RT_Phone_015(path), 0,sheet1, name1,loc,br,br_specific);
		          else if (loc == 22)
		          {
		        	  pass += obj_run(new RT_Phone_016(path), 0,sheet1, name1,loc,br,br_specific);
		        	  logger.info("Reached the last test case");
		          }
