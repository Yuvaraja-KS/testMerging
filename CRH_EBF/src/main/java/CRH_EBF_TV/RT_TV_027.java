...
File Name: 								RT_TV_027
Author: 								Nithin K.S
Description of test case: 				TV - Add Variety channels Ala Carte
...
public class RT_TV_027 extends CommonFunctions {
	...
	public RT_TV_027(String s) {
		this.path = s;
		logger.info("RT_TV_027....");
	}
...
*/
			...
			try {
				...
				if (return_text(".//*[@id='content']/div[3]/div[1]/div/header/div/div[1]/h2", driver).trim().equals(
				...
				//click_element(".//*[@id='content']/div[3]/div[2]/div/div[2]/div[1]/div/div[2]/div/div/div/div[3]/header/ul/li[5]/div/a/span", driver);
				Thread.sleep(5000);
				...
				Customization_TV_addVarietyChannels(br,driver);
				...
				logger.info("RT_TV_027 - Error is : " + e.getMessage());
			}
		} catch (Exception e) {
			exceptionHandler(br, e, driver);
