...
File Name: 								RT_TV_028
Author: 								Nithin K.S
Description of test case: 				TV - Add Adult channels Ala Carte
...
public class RT_TV_028 extends CommonFunctions {
	...
	public RT_TV_028(String s) {
		this.path = s;
		logger.info("RT_TV_028..........");
	}
...
*/
			...
			try {
				...
				Customization_TV_addAdultChannels(br,driver);
				...
				logger.info("RT_TV_028 - Error is : " + e.getMessage());
			}
		} catch (Exception e) {
			exceptionHandler(br, e, driver);
