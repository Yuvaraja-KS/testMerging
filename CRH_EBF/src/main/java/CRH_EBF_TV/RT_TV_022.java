...
File Name: 								RT_TV_022
Author: 								Nithin K.S
Description of test case: 				TV - Exclude Promotion Channel Ala Carte
...
public class RT_TV_022 extends CommonFunctions {
	...
	public RT_TV_022(String s) {
		this.path = s;
		logger.info("RT_TV_022...");
	}
...
*/
			...
			try {
				...
				if (Isavailable(
						".//*[@class='tv-customize-accordion']/div[2]/section/div",
						driver))
					statusTracker(br,driver, 
							"Pass",
				...
				if (Isavailable(
						".//*[@class='morePremiumChannels collapsible-channels']/div/h4",
						driver))
					statusTracker(br,driver, "Pass",
							"Verify the Premium Channels section",
							"Premium Channels tab is displayed by default",
							"Premium Channels tab Should be displayed by default");
				else
					statusTracker(br,driver, "Fail",
							"Verify the Premium Channels section",
							"Premium Channels tab is NOT displayed by default",
							"Premium Channels tab Should be displayed by default");

				logger.info("1111111111");
				Customization_TV_addPremiumChannels(br,driver);
				Thread.sleep(5000);
				 //to take screenshot and save in file
				...
				//Commented the code as per the Review comments from Functional Team
				//Reason : Channels names on channels are not displayed now. SO we have to comment that in code.
				//Validation_CurrentService_Vs_Channels();
				...
				logger.info("RT_TV_022 - Error is : " + e.getMessage());
			}
		} catch (Exception e) {
			exceptionHandler(br, e, driver);
