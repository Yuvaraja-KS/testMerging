...
public abstract class CommonFunctions {
	...
	public static String Grid_Status,pass_screenshot;
	...
	*/
	...
	public void statusTracker( String br, WebDriver driver, String r, String rscenario,
     ...
     String imagename = spath+ "//" + "//Test_Results"+"//"+newFolderPCName+ "////"
                  + "CRH_EBF_TV_Fail_Screenshots//"+br+"////" + Page_Phone
                  + "_Int_Fail";
     ...
     */
     ...
     if (r.equalsIgnoreCase("pass")) {
            ...
            if (pass_screenshot_required == true) {
                  String imagename_1 =spath+ "//" + "//Test_Results"+"//"+newFolderPCName + "////" + "CRH_EBF_TV_Pass_Screenshots//"+br+"////"
	...
	public String exceptionHandler(String br, Exception ex, WebDriver driver) {
		...
		try {
			...
			String Folder_name = "TV_";
			//computer_name folder changes -ankita
			String imagename = spath+"//"+ "//Test_Results" +"//"+newFolderPCName+"//"+"CRH_EBF_TV_Exception_Screenshots////"
					+br+"////" + Page_Phone + "_Ext_Exception";
			SimpleDateFormat ft = new SimpleDateFormat("'_'MMMM dd'_'hh.mma");
			Date dNow = new Date();
	...
	public void setUp(int loc, String br, String name1) throws Exception {
		...
		try {
			if (first == 0) {
				...
				Sheet sheet_url = wb_url.getSheet("TV");
...
*/
	...
	public void firstrun(String br,WebDriver driver, String username, String pwd,
		...
		logger.info("User name enteredd");
...

	{
		...
		String price = driver.findElement(
				By.xpath(".//*[@id='js-main-form']/ul/li/div[3]/div")).getText();
		int index_start = price.indexOf("$");
		logger.info(Integer.toString(index_start));
...
public void page_Cart_One_Time_charge_updater_1(String br,WebDriver driver)
     ...
     mon_total = return_text(
    		 ".//*[@id='content']/div[3]/div[2]/div/div[1]/div/div/div/div[2]/section/div[1]/table/tbody/tr/td[2]",
                  driver);
     statusTracker(br,driver, " ", "cart details", "Monthly one time charges is "
                  + mon_total, "one time charge should be updated in cart");
}
...
//      logger.info(listOfFiles[0].getName());
  	...
  	//String name1 = name.replace(".jpg",".png");
	   File screenshot = ((TakesScreenshot)driver).getScreenshotAs(OutputType.FILE);
		File output_image = new File(Overall_Path +"//Test_Results//"+Folder_Name+ "//CRH_EBF_TV//"+br+"//"+name+".png");
		FileUtils.copyFile(screenshot, output_image);		
		logger.info("copied file into New Images folder"+output_image);
     	File input_image=new File (Overall_Path+"//For_Image_Comparison//"+environment+"//CRH_EBF_TV//"+br+"//"+name+".png");
...
public void EBF_Logout(String br,WebDriver driver) {
	explicit_Wait(3);
	...
	if (Isavailable(".//*[@id='initialAddrForm']/div[2]/div/div/div/div/button", driver))
		...
		statusTracker(br,driver,  "Fail", "Click on the Sign out button",
