...
File Name: 								RT_TV_024
Author: 								Nithin K.S
Description of test case: 				TV - Add Sports Installment Ala Carte
...
public class RT_TV_024 extends CommonFunctions {
	...
	public RT_TV_024(String s) {
		this.path = s;
		logger.info("RT_TV_024...");
	}
...
*/
			...
			try {
				...
				Customization_TV_addSportsChannels_InstallmentPricing(br,driver);
				...
				logger.info("RT_TV_024 - Error is : " + e.getMessage());
			}
		} catch (Exception e) {
			exceptionHandler(br, e, driver);
